        ...
        <DashboardLayout>
            ...
            <div className={style.container}>
                <div className="flex justify-between mt-8">
                    ...
                    <button onClick={() => setAddModal(true)} className="bg-yellow p-4 text-[14px] leading-[17px] text-[#3e3e3e] font-[500] rounded-[6px] sm:mr-4">Add Blog</button>
                </div>
                ...
                {addModal &&
                    <Modal hideModal={() => setAddModal(false)} title="Blog">
                ...
                {editModal &&
                    <Modal hideModal={() => setEditModal(false)} title="Edit Blog">
                        <p className="mb-2 text-[#3e3e3e]">Title</p>
                        <input type="text" className="mb-4 bg-white p-4 rounded-lg  " />
                        <p className="mb-2 text-[#3e3e3e]">Body</p>
                        <textarea name="" id="" className="bg-white h-[200px]"></textarea>
